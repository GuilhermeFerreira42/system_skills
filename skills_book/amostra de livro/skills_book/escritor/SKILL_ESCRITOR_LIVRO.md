...
Cada cena = pasta isolada em `capitulos/capitulo_NN/`. Os nomes abaixo vem todos de `utils/constantes.py` — se a constante mudar, este diagrama fica desatualizado mas o codigo continua funcionando.
