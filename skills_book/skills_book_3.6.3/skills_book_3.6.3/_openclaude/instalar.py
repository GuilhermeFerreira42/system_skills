#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Instalador dos adaptadores OpenClaude — multiplataforma.

Copia os adaptadores para `.openclaude/agents/` na raiz deste sistema, ao lado de
