...
FUNCAO atomizar_cena(caminho_cena):
    ...
    bible = LER("bible/bible_da_obra.md")  // para contexto de conceitos/mundo
...
Arquivo: `{caminho_cena}/_saida_escritor.md` (prosa do escritor)
Arquivo: `{caminho_cena}/_metadados_cena.json` (metadados da cena)
Arquivo: `bible/bible_da_obra.md` (Bible da obra)

---

# 6. Formato de Saida (OBRIGATORIO)

Arquivo: `{caminho_cena}/_afirmacoes_para_validar.json`
...
Arquivo: `{caminho_cena}/_perguntas_validador.json`
