...
**Status:** Versão v3.6 — Alta Escrita com Convicção Calibrada, arquitetura híbrida (5 Movimentos Retóricos + lint de segurança) e fidelidade à fonte. Calibrada contra o Padrão Ouro `PADRAO_OURO_livro_de_referencia.md`.
