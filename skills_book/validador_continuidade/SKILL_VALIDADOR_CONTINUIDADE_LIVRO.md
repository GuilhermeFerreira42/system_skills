...
Arquivo: `{caminho_cena}/_perguntas_continuidade.json` (gerado pelo Orquestrador)
...
Arquivo: `{caminho_cena}/_resultado_continuidade.json`
...
FUNCAO ORQUESTRADOR_GERAR_PERGUNTAS_CONTINUIDADE(saida_escritor, bible, estado_anterior):
    ...
    SALVAR("_perguntas_continuidade.json", perguntas)
```
